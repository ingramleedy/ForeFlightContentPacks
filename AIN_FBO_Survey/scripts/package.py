"""Write manifest.json and zip the AIN FBO Survey pack for ForeFlight import."""
...
ZIP_OUT = ROOT / "AIN_FBO_Survey_Pack.zip"
...
def main() -> int:
    write_manifest()
    if run_validator() != 0:
        print("ERROR: validator reported errors; refusing to zip.", file=sys.stderr)
        return 1
    return zip_pack()
