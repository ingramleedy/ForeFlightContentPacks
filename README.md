...
| [AIN_FBO_Survey](AIN_FBO_Survey/) | ~267 FBOs rated in the 2026 AIN FBO Survey across two toggleable layers (Americas + International). Placemarks color-coded by tier: gold star = Top 5%, orange = Top 10%, yellow = Top 20%, blue = all others surveyed. Tap any pin for FBO name, score, and tier. | `2026.05.18` | ~13 KB | [.zip](https://github.com/ingramleedy/ForeFlightContentPacks/blob/main/AIN_FBO_Survey/AIN_FBO_Survey_Pack.zip?raw=true) |
...
| [Ski_Resorts](Ski_Resorts/) | 400+ US ski resorts as a single toggleable map layer, color-coded by vertical drop: gold star = 3,000+ ft, orange = 1,500–2,999 ft, yellow = 500–1,499 ft, blue = under 500 ft. Tap any pin for summit/base elevation, trails, lifts, acreage, snowfall, and nearest airports. | `2026.05.18` | ~29 KB | [.zip](https://github.com/ingramleedy/ForeFlightContentPacks/blob/main/Ski_Resorts/Ski_Resorts_Pack.zip?raw=true) |
